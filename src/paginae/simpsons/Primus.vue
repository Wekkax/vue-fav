...
<div class="bg-[#ffde00] min-h-screen text-center p-4 flex flex-col items-center justify-center">
    ...
    <div class="flex gap-12">
        ...
        <img class="object-contain hidden md:block mt-20" src="/imagines/simpsons/homer.png" alt="" width="200px" />
        <img class="object-contain mt-12 md:mt-0" src="/imagines/simpsons/moe.png" alt="" width="200px" />
    </div>

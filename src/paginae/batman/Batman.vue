...
import { Loader2, Phone, Mail, MapPin, MessageCircle, X, Instagram, Linkedin, LucideBadgeCheck } from 'lucide-vue-next'
  ...
  <header>
    <div class="batman">
      ...
      <header class="titulus">
        <h1>Batman</h1>
        <div id="titulus-batman" class="titulus-img" @mousemove="cumMouseMove" @mouseleave="cumMouseLeave" :style="{
      ...
      <section id="vehiculis">
        <div class="vehiculis-arca">
          ...
          <div class="item unus">
            <div class="notitia">
              <h2>Avión</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vehicula vulputate elit eget fermentum. Ut
                laoreet ante lacus. Quisque ut tincidunt metus. Curabitur congue, arcu nec tempus sodales, neque sem
                ultrices mauris, eu tincidunt nibh nibh eu massa. Aenean rhoncus quis nibh ac facilisis.</p>
          ...
          <div class="item duo">
            <div class="notitia">
              <h2>Moto</h2>
              <p>Nulla aliquip cupidatat voluptate veniam nostrud aliquip sit enim officia. Sit eu pariatur officia qui
                dolor adipisicing cupidatat. Sit consectetur et eu ut esse laboris nulla.</p>
          ...
          <div class="item tribus">
            <div class="notitia">
              <h2>Coche</h2>
              <p>Irure adipisicing est minim eu ad dolor. Eu ea commodo pariatur ut occaecat in cupidatat reprehenderit
                ut laborum duis. Sunt minim ex fugiat reprehenderit. Lorem consectetur reprehenderit commodo non</p>
      ...
      <section id="videre" class="bg-gray-900 w-full flex justify-center items-center min-h-[60vh] lg:min-h-[95vh]">
        <CarrusImaginum base-path="/imagines/batman" :photos=photos :autoplay-delay="3000" />
          ...
          <div class="flex flex-col lg:flex-row gap-8 items-center">
            ...
            <div class="hidden lg:block w-full lg:w-1/2 rounded-lg overflow-hidden shadow-lg">
              <div class="aspect-square">
                ...
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6158.914236698148!2d-0.36275355279877275!3d39.481591517264974!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd60488259073375%3A0xfb410ba707ca33c9!2sUPV%20-%20Facultad%20de%20Bellas%20Artes%20BBAA!5e0!3m2!1ses!2ses!4v1776446718717!5m2!1ses!2ses"
